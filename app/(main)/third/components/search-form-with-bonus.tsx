...
export default function SearchFormWithBonus({ children, className, handleSubmit, countries, handleItemChange }: { children: React.ReactNode, className?: string, handleSubmit: (selectedItem: GeoEntity | null) => void, countries: GeoEntity[], handleItemChange: (selectedItem: GeoEntity | null) => void }) {
